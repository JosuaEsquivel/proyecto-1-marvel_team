...
public class Constants {
    ...
    public static final Object[] TABLE_HEADER = {"Id", "Day","Month","Year","Name", "AssociatedDiseases", "Observations"};
    public static final String IMAGESSETTING = "Conograma/src/main/resources/Setting.png";
